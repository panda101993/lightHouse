                        ...
                        <nav class="top-nav">
                            <div class="right-top">
                                <ul class="right-sideloctn">
                                    ...
                                    <li>
                                        <a href="#" data-toggle="modal" data-target="#fill-loctnform" onClick={() => setModal1(!modalStatus1)}>{showLocationTitle ? "Choose location" : getAddressData() }<i class="" aria-hidden="true"></i></a>
