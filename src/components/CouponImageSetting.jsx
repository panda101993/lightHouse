               ...
               <ModalBody>
                  ...
                  <label style={{fontSize:14}}>{this.state.restrictions}</label> 
                        ...
                        <div class="modal-body ny">
                           ...
                           <button type="button" class="btn setloc-ap cl" type="submit" data-dismiss="modal" data-toggle="modal" data-target="#coup-wish-success" onClick={() => this.openDelteModal(this.state.getCouponId)} >Delete</button>
