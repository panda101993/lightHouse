...
export class CouponImageSetting extends Component { 
    constructor(props) {
      ...
      getCoupounList =()=>{
      try {
       Apirequest({userId:"5ed225b7d338d32b5fa19b7e",search:this.state.search,pageNumber:this.state.pageNumber,limit:this.state.limit},'/user/myCoupons','POST',"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjVlZDIyNWI3ZDMzOGQzMmI1ZmExOWI3ZSIsImlhdCI6MTU5MDgzMDUxNywiZXhwIjoxNTkwOTE2OTE3fQ._-wXU1lHRPc4tQiZklL7aLYPM-OHqKMfIIa9OUa_Tfk")
       .then((resp)=>{
     ...
     async componentDidMount() {
      ...
      deleteCoupans = () => {
         try {
            Apirequest({couponId:""},'/user/deleteCoupon','POST',"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjVlZDIyNWI3ZDMzOGQzMmI1ZmExOWI3ZSIsImlhdCI6MTU5MDgzMDUxNywiZXhwIjoxNTkwOTE2OTE3fQ._-wXU1lHRPc4tQiZklL7aLYPM-OHqKMfIIa9OUa_Tfk")
            .then((resp) => {
      ...
      hideCoupans = () => {
         try {
            Apirequest({couponId:"" },'/user/hideCoupon','POST',"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjVlZDIyNWI3ZDMzOGQzMmI1ZmExOWI3ZSIsImlhdCI6MTU5MDgzMDUxNywiZXhwIjoxNTkwOTE2OTE3fQ._-wXU1lHRPc4tQiZklL7aLYPM-OHqKMfIIa9OUa_Tfk")
            .then((resp)=>{
               console.log('response',resp);
               this.setState({ modalStatusImage: !this.state.modalStatusImage })
            })
