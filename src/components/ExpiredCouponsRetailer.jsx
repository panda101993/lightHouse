...
// export default class ExpiredCoupansRetailer extends Component {
//     constructor(props) {
//         super(props)
...
class ExpiredCoupansRetailer extends Component {
    constructor(props) {
        super(props)
...
const mapStateToProps = state => {
 ...
 export default connect(mapStateToProps)(ExpiredCoupansRetailer);
