...
export class ManageInfoEndUser extends Component {
   constructor(props) {
      ...
      this.state = {
         ...
         modalStatus: false,
         modalStatusResend: false,
         modalStatusWeekly: false
      }
   }

   componentDidMount(){
      this.setState({modalStatusWeekly: !this.props.applicatonkey.weeklyEmail})
   }
         ...
         if (this.state.otpStatus2) {
            if (this.state.otpStatus3) {
               if (this.state.otpStatus4) {
                  ...
                  console.log("props",this.props.applicatonkey.weeklyEmail)
   ...
   render() {
      // const {data} = this.props.applicatonkey
      return (
         <div>
            ...
            <button onClick={() => this.setState({ modalStatus: false })} type="button" class="close" data-dismiss="modal" aria-label="Close">
               ...
               <Modal isOpen={this.state.modalStatusWeekly} toggle={this.toggle} style={{ top: "190px", }}>
                  <ModalBody>
                     {/* <form>
                                <div class="modal-header locationsethead">
                                    <h5>OTP resent successfully.</h5>
                     ...
                     {/* <div class="modal fade" id="congrats-kaml" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true"> */}
                        {/* <div class="modal-dialog modal-dialog-centered" role="document"> */}
                           <div class="modal-content">
                              <div class="modal-body sign_up" style={{alignSelf:"center"}}>
                                 <h3>Congratulation Kamal,you haveSuccesfully login into the website !</h3>
                                 <p>Please sign up for optional weekly email of the near by coupons.</p>
                              </div>
                              <div class="modal-footer botton_modal">
                               <button type="button" class="save" >OK</button>
                              </div>
                           </div>
                        {/* </div> */}
                     {/* </div> */}
...
const mapStateToProps = state => {
   ...
   return {
      applicatonkey: state.AuthReducer.tempUserData
      
   }
}
export default connect(mapStateToProps)(ManageInfoEndUser);
